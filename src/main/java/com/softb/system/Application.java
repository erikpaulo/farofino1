...
import com.softb.system.logging.config.JavaMailSenderConfig;
...
@Import(value={WebMvcConfig.class, ServiceConfig.class, SecurityConfig.class, CacheConfig.class, RepositoryConfig.class, JavaMailSenderConfig.class})
