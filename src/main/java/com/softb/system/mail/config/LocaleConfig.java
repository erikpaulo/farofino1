package com.softb.system.mail.config;

import com.softb.system.locale.LocaleContextHolderWrapper;
import com.softb.system.locale.config.AngularCookieLocaleResolver;
...
public class LocaleConfig extends WebMvcConfigurerAdapter implements EnvironmentAware {
    ...
    @Bean
    public LocaleContextHolderWrapper localeContextHolderWrapper() {
